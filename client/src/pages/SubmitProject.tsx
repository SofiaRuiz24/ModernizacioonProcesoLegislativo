...
export function SubmitProject() {
  ...
  const { getRootProps: getSignatureProps, getInputProps: getSignatureInput } =
    useDropzone({
  ...
  const { getRootProps: getProjectProps, getInputProps: getProjectInput } =
    useDropzone({
        ...
        <Card className="shadow-sm border-0">
          <div className="p-6 border-b">
            ...
            <p className="text-muted-foreground mt-1">
              Complete el formulario para presentar su proyecto
            </p>
          </div>
                    ...
                    {signatures ? (
                      ...
                      <>
                        ...
                        <p className="text-sm text-gray-600">
                          Arrastra o haz clic para subir el documento de firmas
                          (PDF)
                        </p>
...
function CreateSessionCard() {
  ...
  return (
    <Card className="shadow-sm border-0 mt-8">
      <div className="p-6 border-b">
        <h1 className="text-2xl font-semibold tracking-tight">
          Crear Sesión (Votación Legislatura)
        </h1>
        <p className="text-muted-foreground mt-1">
          Ingrese la fecha y descripción para crear una nueva sesión (según el
          smartcontract).
        </p>
      </div>
      <form onSubmit={createSession} className="p-6 space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="descrip" className="text-sm font-medium">
            Descripción (por ejemplo, "Sesión de fin de año")
          </Label>
          <Input
            id="descrip"
            value={descrip}
